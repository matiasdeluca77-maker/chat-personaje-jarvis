...
// Cada uno tiene: id, nombre, descripción corta (para las tarjetas de la galería)
// y su systemPrompt (lo que define su personalidad ante Gemini).
...
// Devuelve un array (útil para recorrer y armar la galería de tarjetas)
export function getCharacterList() {
  return Object.values(CHARACTERS);
}

// Devuelve un personaje por id, o null si no existe
